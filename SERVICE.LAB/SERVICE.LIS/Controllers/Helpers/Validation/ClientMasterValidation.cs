        ...
        public static ErrorResponse InsertClientMasterDetails(PostCustomerMaster req)
        {
            ...
            if (req.tblcustomer != null)
            {
                if (req.tblcustomer.IsApproval == 0)
                {
                    ...
                    if (_csvcheck.IsMatch(req.tblcustomer.CustomerName ?? "".ToSubstring((req.tblcustomer.CustomerName ?? "").Length)) || 
                        _csvcheck.IsMatch(req.tblcustomer.CShortName ?? "".ToSubstring((req.tblcustomer.CShortName ?? "").Length)) ||
                        _csvcheck.IsMatch(req.tblcustomer.CustomerCode ?? "".ToSubstring((req.tblcustomer.CustomerCode ?? "").Length)) || 
                        _csvcheck.IsMatch(req.tblcustomer.ContactPersonName ?? "".ToSubstring((req.tblcustomer.ContactPersonName ?? "").Length)) ||
                        _csvcheck.IsMatch(req.tblcustomer.CustomerMobileNo ?? "".ToSubstring((req.tblcustomer.CustomerMobileNo ?? "").Length)) || 
                        _csvcheck.IsMatch(req.tblcustomer.CustomerEmail ?? "".ToSubstring((req.tblcustomer.CustomerEmail ?? "").Length)) ||
                        _csvcheck.IsMatch(req.tblcustomer.UserName ?? "".ToSubstring((req.tblcustomer.UserName ?? "").Length)) || 
                        _csvcheck.IsMatch(req.tblcustomer.Address ?? "".ToSubstring((req.tblcustomer.Address ?? "").Length)) || 
                        _csvcheck.IsMatch(req.tblcustomer.Area ?? "".ToSubstring((req.tblcustomer.Area ?? "").Length)) ||
                        _csvcheck.IsMatch(req.tblcustomer.Pincode ?? "".ToSubstring((req.tblcustomer.Pincode ?? "").Length)) || 
                        _csvcheck.IsMatch(req.tblcustomer.secondaryemail ?? "".ToSubstring((req.tblcustomer.secondaryemail ?? "").Length)))
