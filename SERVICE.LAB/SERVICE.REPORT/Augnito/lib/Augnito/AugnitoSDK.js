...
(function (window) {
    ...
    var AugnitoSDK = function (cfg) {
        ...
        config.PersonalizationURL = config.PersonalizationURL || EMPTY;
        ...
        this.stopListeningPromise = function () {
            // If the socket errors resolve the promise and cancel the close handler
