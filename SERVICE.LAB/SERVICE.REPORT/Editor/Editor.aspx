...
<body>
    ...
    <div>
        <form id="form1" runat="server" style="display: block">
                        ...
                        <dx:ASPxPanel ID="Panel1" runat="server" DefaultButton="btOK">
                            <PanelCollection>
                                <dx:PanelContent runat="server">
                                    <div>
                                        <textarea id="txtDiag" class="form-control textareaCss report-input" rows="10"></textarea>
                                    </div>
            ...
            <div>
                <dx:ASPxRichEdit ID="ASPxRichEdit1" runat="server" OnSaving="RichEdit_Saving" Width="50%"
                    OnSpellCheckerWordAdded="ASPxRichEdit1_SpellCheckerWordAdded" ClientInstanceName="RichEdit">
                    <ClientSideEvents Init="function(s, e){ s.toggleFullScreenMode(); }" CustomCommandExecuted="onCustomCommandExecuted" />
                    <SettingsDialogs>
