...
namespace QCManagement.ServiceErrors
{
    ...
    {
        public static class StrainMediaMapping
        {
            public static Error NotFound => Error.NotFound(code: "StrainMediaMapping.NotFound", description: "StrainMediaMapping not found");
