...
{
    public class RegisteredProductsEntityConfiguration : IEntityTypeConfiguration<RegisteredProduct>
    {
        public void Configure(EntityTypeBuilder<RegisteredProduct> builder)
        {
