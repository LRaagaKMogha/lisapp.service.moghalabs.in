...
namespace Shared
{
    ...
    public class JwtUtils : IJwtUtils
    {
        ...
        public string GenerateToken(User? user = null)
        {
            if (user == null) user = new User(true, true, 1, 1, 1, "BloodBankMasters", true, new List<string> { "BloodBankMasters" });
            if(user != null && user.Roles != null && !user.Roles.Any(x => x == "BloodBankMasters")) user.Roles.Add("BloodBankMasters");
